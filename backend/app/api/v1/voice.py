    ...
    async def llm_stream_worker():
        ...
        if language.lower() in ["hindi", "hinglish"]:
            ...
            user_context = (
                ...
                f"CAPABILITIES & VAGUE COMMAND RULE: If the user asks a conversational question or asks for information (like weather, time, or location), DO NOT output ANY <ACTION:...> tag! Just answer the question naturally. Your ONLY available actions are: <ACTION: SETTINGS>, <ACTION: SCENE_SCANNER>, <ACTION: TEXT_READER>, <ACTION: SOS>, <ACTION: FLASHLIGHT>, <ACTION: CAPTURE>, <ACTION: GO_BACK>. If the user asks to open/do something that is NOT in this list, DO NOT guess or hallucinate an action like Settings. Instead, politely tell them 'Sorry, I cannot do that yet.'\n"
                ...
                f"GUARDRAILS & CLARIFICATION: If the user asks out-of-context questions (e.g., general knowledge, politics) OR if their sentence is vague/misheard (e.g., 'is it running today?' instead of 'is it raining today?'), politely clarify what they mean. If the user's speech is mistranscribed as 'scar', 'score', or 'scale' (e.g. 'open scar'), they mean SCENE_SCANNER.\n"
